...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8;
...
void StartTask1(void *argument)
{
  ...
  for(;;)
  {
    uint8_t dataTask1[] = "Task1: Green Light and state controller\r\n";

	  HAL_UART_Transmit(&huart2, dataTask1, sizeof(dataTask1), 1000);
	  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_10, GPIO_PIN_RESET);
...
void StartTask2(void *argument)
{
  ...
  for(;;)
  {
    uint8_t dataTask2[] = "Task2: Yellow Light\r\n";
...
void StartTask3(void *argument)
{
  ...
  for(;;)
  {
    uint8_t dataTask3[] = "Task3: Red Light\r\n";
...
void StartTask4(void *argument)
{
  ...
  for(;;)
  {
	  uint8_t dataTask4[] = "Task 4: Pedestrian green light\r\n";
...
void StartTask6(void *argument)
{
  ...
  for(;;)
  {
    uint8_t dataTask3[] = "Task6: Pedestrian Red Light\r\n";
	  HAL_UART_Transmit(&huart2, dataTask3, sizeof(dataTask3), 1000);
